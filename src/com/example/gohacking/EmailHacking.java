...
public class EmailHacking extends Activity {
	TextView tv;
	String nh;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_email_hacking);
		tv = (TextView) findViewById(R.id.emhc);
		nh="Email hacking is the process of recovering secret passwords from data that has been stored in or transmitted by a computer system. A common approach is to repeatedly try guesses for the password. Most passwords can be cracked by using following techniques :"
+" 1)Hashing :" +
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.email_hacking, menu);
		return true;
	}
