...
public class PasswordHacking extends Activity {
	TextView tv;
	String nh;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_password_hacking);
		tv = (TextView) findViewById(R.id.pwhc);
		nh="Password Cracking is the process of recovering secret passwords from data that has been stored in or transmitted by a computer system. A common approach is to repeatedly try guesses for the password. Most passwords can be cracked by using following techniques :"
+" 1)Hashing :" +
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.password_hacking, menu);
		return true;
	}
