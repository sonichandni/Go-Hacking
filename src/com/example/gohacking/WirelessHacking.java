...
public class WirelessHacking extends Activity {
	TextView tv;
	String nh;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_wireless_hacking);
		tv = (TextView) findViewById(R.id.wlhc);
...
+" 1)Hashing :" +
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.wireless_hacking, menu);
		return true;
	}
